...
integration-test: ## Run integration tests with docker-compose
	...
	@docker compose up -d
	@sleep 5
	@curl -sSL -D - http://localhost -o /dev/null | head -n 2 || { docker compose down; exit 1; }
	@docker compose down
...
docs: ## Generate documentation
	@echo "$(GREEN)Documentation is in README.md, SECURITY.md, and CLAUDE.md$(NC)"
